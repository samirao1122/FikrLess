...
import '../../../widgets/audio_player_notification.dart';
import '../mood/mood_tracking_screen.dart';
import '../profile/profile_screen.dart';
import '../notifications/notifications_screen.dart';
import '../activities/goal_screen.dart';
import '../activities/journal_screen.dart';
import '../activities/specialist_screen.dart';
import '../activities/exercise_screen.dart';
import '../social/article_screen.dart';
import '../social/forum_screen.dart';
import '../social/chat_screen.dart';
import '../wellness/wellness_screen.dart';
import '../wellness/spiritual_hub_screen.dart';

class HomeScreen extends StatefulWidget {
  final Locale locale;
  static final GlobalKey<State<HomeScreen>> navigatorKey = GlobalKey<State<HomeScreen>>();

  HomeScreen({required this.locale}) : super(key: navigatorKey);

  @override
  State<HomeScreen> createState() => _HomeScreenState();

  /// Navigate to a specific tab (0 = Home, 1 = Article, 2 = Chat, 3 = Forum, 4 = Wellness)
  static void navigateToTab(int index) {
    final state = navigatorKey.currentState;
    if (state != null && state.mounted && state is _HomeScreenState) {
      (state as _HomeScreenState)._navigateToTab(index);
    }
  }
}
  ...
  Future<void> _loadMood() async {
    ...
    if (mounted) {
      setState(() {
        ...
        if (moodData != null) {
          // Response structure: { "mood": "...", ... } (already extracted from data)
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Audio player notification overlay
          AudioPlayerNotification(locale: widget.locale),
        ],
      ),
